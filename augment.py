...
from libraries.stylegan2_ada_pytorch.torch_utils.ops import upfirdn2d
from libraries.stylegan2_ada_pytorch.torch_utils.ops import grid_sample_gradfix
from libraries.stylegan2_ada_pytorch.torch_utils.ops import conv2d_gradfix
...
class AugmentPipe(torch.nn.Module):
    ...
    def forward(self, _images, debug_percentile=None):
        images = _images[:, :3, ...]
        ...
        if G_inv is not I_3:
            ...
            images = torch.nn.functional.pad(input=images, pad=[mx0,mx1,my0,my1], mode='constant', value=1)
        ...
        images = torch.cat([images, _images[:, 3:, ...]], 1)
