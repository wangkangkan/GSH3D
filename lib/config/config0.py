...
# data
cfg.human = 313
cfg.training_view = [0,5,7,9,10,11]#[0,11]#[0, 5, 9, 11]#[0,1,2,4,5,7,8,9,10,11,12]#[5,6,7,10]#[30, 40, 50, 70]#
cfg.raw_view = [0,1,2,10,20,30,40,50,60,65,70,75,80,85,90]
cfg.intv = 1
cfg.begin_ith_frame = 700  # the first smpl
...
parser.add_argument('--vis_mesh',type=bool, default=False)
