...
class TriNARFGenerator(nn.Module):  # tri-plane nerf
    ...
    def forward(self, frameidx, rawimg, ray_o, ray_d, near, far, mask_at_box, smplposes, smpltrans, smplscale, extrinsics, intrinsic, bone_mask, pose_to_camera, pose_to_world, bone_length, z=None, inv_intrinsics=None,
        ...
        nerf_output = self.nerf(frameidx, rawimg, batchsize, homo_img, ray_o, ray_d, near, far, mask_at_box, smplposes, smpltrans, smplscale, extrinsics,intrinsic,bone_mask,
                                pose_to_world, pose_to_camera, inv_intrinsics, z_for_nerf,
                                z_for_neural_render,
                                bone_length,
        ...
        fg_color0 = fg_color.reshape(batchsize, self.size, self.size, 3)
