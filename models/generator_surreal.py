...
class TriNARFGenerator(nn.Module):  # tri-plane nerf
    ...
    def forward(self, frameidx, rawimg, ray_o, ray_d, near, far, mask_at_box, poses, betas, trans, shift, joints2D, extrinsics, intrinsic, bone_mask, pose_to_world, bone_length, z=None, inv_intrinsics=None,
        ...
        nerf_output = self.nerf(frameidx, rawimg, batchsize, ray_o, ray_d, near, far, mask_at_box, poses, betas, trans, shift, joints2D, extrinsics,intrinsic,
        ...
        fg_mask = fg_mask.reshape(batchsize, 90, 90)
        ...
        return rendered_color, fg_mask, samplepts_disp#, fine_weights, fine_depth
