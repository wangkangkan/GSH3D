...
class BaseOptions():
    ...
    def initialize(self):
        ...
        dataset.add_argument("--dataset_path", type=str, default='.../ENARF-GAN-main/data/DeepFashion')
        ...
        training.add_argument("--glr", type=float, default=2e-3)#2
        ...
        guassian = self.parser.add_argument_group('guassian')
        guassian.add_argument("--lr_point", type=float, default=0.0002, help='lr')
        guassian.add_argument("--lr_xyz", type=float, default=0.0002, help='lr')
        guassian.add_argument("--lr_vembed_smpl", type=float, default=0.001, help='lr')
        guassian.add_argument("--lr_vembed_cloth", type=float, default=0.001, help='lr')
        guassian.add_argument("--lr_geometry_smpl", type=float, default=0.001, help='lr')
        guassian.add_argument("--lr_geometry_cloth", type=float, default=0.001, help='lr')
        guassian.add_argument("--lr_appearance_smpl", type=float, default=0.001, help='lr')
        guassian.add_argument("--lr_appearance_cloth", type=float, default=0.001, help='lr')
        guassian.add_argument("--lr_displace_cloth", type=float, default=0.001, help='lr')
        guassian.add_argument("--lr_deform_cloth", type=float, default=0.001, help='lr')
        guassian.add_argument("--lr_simul", type=float, default=0.001, help='lr')
        guassian.add_argument("--densify_from_iter", type=int, default=500, help='densify')
        guassian.add_argument("--densification_interval", type=int, default=600, help='densify')
        guassian.add_argument("--densify_grad_threshold", type=float, default=0.0002, help='densify')
        guassian.add_argument("--prune_min_opacity", type=float, default=0.005, help='densify')
        guassian.add_argument("--densify_extent", type=float, default=1.0, help='densify')
        guassian.add_argument("--max_n_gaussians", type=int, default=524288, help='densify')
        guassian.add_argument("--densify_until_iter", type=int, default=5000, help='densify')
