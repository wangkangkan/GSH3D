							...
							float* cov2D, float* camera_plane, float3* output_normal, float2* ray_plane, float& coef, float* invraycov3Ds = nullptr)
{
    ...
    //printf("%d %f\n",well_conditioned,Vrk_eigen_value[min_id]);
	...
	else
	{
        ...
        //printf("%f %f %f %f %f %f %f %f %f\n",plane.x,plane.y,nJ_inv[0][0],nJ_inv[0][1],nJ_inv[1][0],nJ_inv[1][1],uvh_mn[0],uvh_mn[1],uvh_mn[2]);
        //printf("%f %f %f %f %f %f\n",nJ_inv[0][0],nJ_inv[0][1], uvh_mn[0],uvh_mn[1],uvh_mn[2],nJ_inv[0][0]*uvh_mn[0]+nJ_inv[0][1]*uvh_mn[1]);
		float nl = u2+v2+1;
		...
		*ray_plane = {plane[0]*l/nl/focal_x, plane[1]*l/nl/focal_y};
        ...
        //printf("%f %f %f %f %f\n",normal_vector.x, normal_vector.y, plane[0],plane[1],factor_normal);
	...
	if (inside)
	{
		...
		if constexpr (NORMAL)
		{
			if(last_contributor)
			{
                ...
                //printf("%f %f %f %f %f %f\n",Normal[0], Normal[1], Normal[2],Normal[0]/len_normal, Normal[1]/len_normal, Normal[2]/len_normal);
			}
			else
			{
